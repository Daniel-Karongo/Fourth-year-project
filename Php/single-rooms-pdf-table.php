<?php
    ...
    $pdf->Cell(125,16,'');
    $pdf->Cell(105,24,'Single Rooms',0,1);
    ...
    for($i=0; $i<count($singlerooms); $i++) {
        ...
        $pdf->Cell(50,6,$singlerooms[$i][1],1,0,'C');
        $pdf->Cell(50,6,$singlerooms[$i][2],1,0,'C');
        // $pdf->Cell(40,6,$property_owners[$i][2],1,0,'C');
        $pdf->Cell(50,6,$singlerooms[$i][3],1,0,'C');
        $pdf->Cell(50,6,$singlerooms[$i][6],1,0,'C');
        $pdf->Cell(50,6,$singlerooms[$i][7],1,1,'C');

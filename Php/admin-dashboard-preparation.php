    ...
    function getAdministrators() {
        ...
        if (mysqli_num_rows($res) > 0) {
            ...
            while ($adminRetrieved = mysqli_fetch_assoc($res)) {
                ...
                $administrators[$i][3] = $adminRetrieved['Password'];
                $administrators[$i][4] = $adminRetrieved['First_Name'];
                $administrators[$i][5] = $adminRetrieved['Last_Name'];
                $administrators[$i][6] = $adminRetrieved['Password_Reset_Confirmation_Code'];
                $administrators[$i][7] = $adminRetrieved['Remember_Me'];

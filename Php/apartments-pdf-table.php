<?php
    ...
    $pdf->Cell(115,16,'');
    $pdf->Cell(105,24,'Apartments',0,1);
    ...
    for($i=0; $i<count($apartments); $i++) {
        ...
        $pdf->Cell(40,6,$apartments[$i][1],1,0,'C');
        $pdf->Cell(40,6,$apartments[$i][2],1,0,'C');
        $pdf->Cell(50,6,$apartments[$i][3],1,0,'C');
        $pdf->Cell(50,6,$apartments[$i][6],1,0,'C');
        $pdf->Cell(50,6,$apartments[$i][7],1,0,'C');
        $pdf->Cell(50,6,$apartments[$i][8],1,1,'C');

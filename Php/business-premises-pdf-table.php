<?php
    ...
    $pdf->Cell(115,16,'');
    $pdf->Cell(105,24,'Business Premises',0,1);
    ...
    for($i=0; $i<count($businesspremises); $i++) {
        ...
        $pdf->Cell(50,6,'Type Of Premise',1,0,'C');
        ...
        $pdf->Cell(40,6,$businesspremises[$i][1],1,0,'C');
        $pdf->Cell(50,6,$businesspremises[$i][2],1,0,'C');
        $pdf->Cell(40,6,$businesspremises[$i][3],1,0,'C');
        $pdf->Cell(50,6,$businesspremises[$i][4],1,0,'C');
        $pdf->Cell(50,6,$businesspremises[$i][7],1,0,'C');
        $pdf->Cell(50,6,$businesspremises[$i][8],1,1,'C');

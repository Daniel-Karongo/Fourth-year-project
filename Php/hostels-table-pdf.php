<?php
    ...
    for($i=0; $i<count($hostels); $i++) {
        ...
        $pdf->Cell(50,6,$hostels[$i][1],1,0,'C');
        $pdf->Cell(50,6,$hostels[$i][2],1,0,'C');
        // $pdf->Cell(40,6,$property_owners[$i][2],1,0,'C');
        $pdf->Cell(50,6,$hostels[$i][3],1,0,'C');
        $pdf->Cell(50,6,$hostels[$i][6],1,0,'C');
        $pdf->Cell(50,6,$hostels[$i][7],1,1,'C');

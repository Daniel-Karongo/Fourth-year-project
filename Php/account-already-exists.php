    ...
    <div class="container">
        <div class="main-body">
            ...
            <div class="heading">
                ...
                <p>Note: This is the account you will use to advetrtise your rentals and manage those you aready have.</p>
            </div>
            <div class="actual-form">
                <form action="../Php/account-verification-preparation.php" method="post" onsubmit="validateForm(event)">
                    <div class="names">
                    ...
                    <div class="passwords">
                        <div class="password-entry">
                            <div class="create-password">
                                <div class="label-create-password">
                        ...
                        <div class="edit-options">
                            <div class="hint">
                                <div class="label-hint">
                                    <label for="">Use 8 or more characters mith a mix of letters, numbers and symbols</label>
                                </div>                  
                            </div>                   
                    ...
                    <div class="already-signed-in">
                        <a href="../Html/login.html"> Already have an account, sign in instead</a>
                    </div>                            
        ...
        <div class="periphery">
            <a href="../Html/login.html" class="sign-in" onmouseenter="zoomDiv(this)" onmouseleave="unzoomDiv(this)">Back</a>
        </div>        
    </div>
